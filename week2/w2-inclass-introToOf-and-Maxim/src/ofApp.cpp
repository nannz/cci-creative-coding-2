...
void ofApp::setup(){
    ...
    //how to load sample with MaxiSample
    //mySample.load(ofToDataPath("filename.wav"));
...
void ofApp::audioOut(ofSoundBuffer& output){
    ...
    for (int i = 0; i < output.getNumFrames(); ++i){
        ...
        //float myOut = mySample.play(1.2);
        
        output[i * outChannels] = myOsc1.sinewave(myFreq+ (myOsc2.sinewave(0.2)*10)) * 0.5;//a square wave with freq as 532, and amp as 0.5
