...
void ofApp::setup(){
    ...
    float sphereScale = 0.15;
    int sphereRadius = ofGetWidth() * sphereScale;
    int sphereGridSize = 5;
    int sphereResolution =sphereRadius/sphereGridSize;
    sphere.set(sphereRadius,sphereResolution,OF_PRIMITIVE_TRIANGLE_STRIP);//(float radius, int resolution, ofPrimitiveMode mode=OF_PRIMITIVE_TRIANGLE_STRIP)
